...
/*
the main menu customization is made by BeastlyGhost, shoutout to her!
*/
typedef MenuData =
{
...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "FNF Vs. AumSum DE v" + psychEngineVersion, 12);
