...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Opponent CrossFade Limit', "Determines the maximium amount of frames of CrossFade the opponent can have. (Doesn't function yet)",
		...
		var option:Option = new Option('BF CrossFade Limit', "Determines the maximium amount of frames of CrossFade the player can have. (Doesn't function yet)",
		...
		var option:Option = new Option('CrossFade Mode:', "What mode should CrossFade be in? (Doesn't function yet)", 'crossFadeMode', 'string', 'Mid-Fight Masses',
		...
		var option:Option = new Option('Disable Mouse Controls', "If checked, there won't be mouse controls\nin the Freeplay, Story Mode and Pause menus.",
			'noMouse', 'bool', false);
		addOption(option);
